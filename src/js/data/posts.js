const posts = [{
  ...
  code: '-hZh6IQcfN',
  caption: 'New Stickers just came in. I\'ll do another mailing in a few'
  + 'weeks if you want some. #javascript',
  likes: 66,
  ...
  code: '_4jHytwcUA',
  caption: '2015 can be summed up with one baby and a many lines'
  + 'of code. And sometimes a coding baby. 👶🏼⌨',
  likes: 62,
  ...
  code: '_A2r0aQcfD',
  caption: 'Some serious hardware meet JavaScript '
  + 'hacks going down this week at hackeryou. Excited for demo day!',
  likes: 57,
  ...
  + 'hphotos-xaf1/t51.2885-15/e35/12224456_175248682823294_1558707223_n.jpg'
}, {
  code: '-FpTyHQcau',
  caption: 'I\'m in Austin for a conference and doing some training. '
  + 'Enjoying some local brew with my baby.',
  likes: 82,
